...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/home/gustavo/.local/lib/python3.6/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/home/gustavo/.local/lib/python3.6/site-packages/numpy/core/include/numpy/ufuncobject.h",
            "c_odes.h"
        ],
        "include_dirs": [
            ".",
            "/home/gustavo/.local/lib/python3.6/site-packages/numpy/core/include"
        ],
        "library_dirs": [
            "."
        ],
...
#define __PYX_HAVE__c_odes
#define __PYX_HAVE_API__c_odes
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'c_odes_def' */

/* Module declarations from 'c_odes' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_double_t = { "double_t", NULL, sizeof(__pyx_t_5numpy_double_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "c_odes"
extern int __pyx_module_is_main_c_odes;
int __pyx_module_is_main_c_odes = 0;

/* Implementation of 'c_odes' */
...
static const char __pyx_k_c_odes[] = "c_odes";
static const char __pyx_k_double[] = "double";
static const char __pyx_k_import[] = "__import__";
static const char __pyx_k_cy_odes[] = "cy_odes";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_c_odes_wrapper_pyx[] = "c_odes_wrapper.pyx";
...
static PyObject *__pyx_n_s_c_odes;
static PyObject *__pyx_kp_s_c_odes_wrapper_pyx;
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_cy_odes;
...
static PyObject *__pyx_pf_6c_odes_cy_odes(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_y, CYTHON_UNUSED double __pyx_v_t); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_6c_odes_1cy_odes(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6c_odes_1cy_odes = {"cy_odes", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6c_odes_1cy_odes, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6c_odes_1cy_odes(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_y = 0;
  CYTHON_UNUSED double __pyx_v_t;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cy_odes (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_t)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("cy_odes", 1, 2, 2, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cy_odes") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
    ...
    __pyx_v_t = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_t == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("cy_odes", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("c_odes.cy_odes", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_6c_odes_cy_odes(__pyx_self, __pyx_v_y, __pyx_v_t);
...
static PyObject *__pyx_pf_6c_odes_cy_odes(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_y, CYTHON_UNUSED double __pyx_v_t) {
  ...
  __Pyx_RefNannySetupContext("cy_odes", 0);
  ...
  __pyx_pybuffernd_y.rcbuffer = &__pyx_pybuffer_y;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_y.rcbuffer->pybuffer, (PyObject*)__pyx_v_y, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 8, __pyx_L1_error)
  }
  __pyx_pybuffernd_y.diminfo[0].strides = __pyx_pybuffernd_y.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_y.diminfo[0].shape = __pyx_pybuffernd_y.rcbuffer->pybuffer.shape[0];

  /* "c_odes_wrapper.pyx":10
 * def cy_odes(cnp.ndarray[cnp.double_t, ndim=1] y, double t):
 *     # preallocate our output array
 *     cdef cnp.ndarray[cnp.double_t, ndim=1] dY = np.empty(y.size, \             # <<<<<<<<<<<<<<
 *             dtype=np.double)
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_y), __pyx_n_s_size); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_double); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dY.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_6 = 0;
  __pyx_v_dY = ((PyArrayObject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "c_odes_wrapper.pyx":13
 *             dtype=np.double)
 *     # now call the C function
 *     c_odes_def.c_odes(<double *> y.data, <double *> dY.data)             # <<<<<<<<<<<<<<
 *     return dY
 */
  c_odes(((double *)__pyx_v_y->data), ((double *)__pyx_v_dY->data));

  /* "c_odes_wrapper.pyx":14
 *     # now call the C function
 *     c_odes_def.c_odes(<double *> y.data, <double *> dY.data)
 *     return dY             # <<<<<<<<<<<<<<
 */
...
static int __pyx_pymod_exec_c_odes(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_c_odes},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_c_odes, __pyx_k_c_odes, sizeof(__pyx_k_c_odes), 0, 0, 1, 1},
  {&__pyx_kp_s_c_odes_wrapper_pyx, __pyx_k_c_odes_wrapper_pyx, sizeof(__pyx_k_c_odes_wrapper_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_cline_in_traceback, __pyx_k_cline_in_traceback, sizeof(__pyx_k_cline_in_traceback), 0, 0, 1, 1},
  {&__pyx_n_s_cy_odes, __pyx_k_cy_odes, sizeof(__pyx_k_cy_odes), 0, 0, 1, 1},
 ...
 *     cdef cnp.ndarray[cnp.double_t, ndim=1] dY = np.empty(y.size, \
 */
  __pyx_tuple__8 = PyTuple_Pack(3, __pyx_n_s_y, __pyx_n_s_t, __pyx_n_s_dY); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(2, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_c_odes_wrapper_pyx, __pyx_n_s_cy_odes, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initc_odes(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initc_odes(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_c_odes(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_c_odes(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_c_odes(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'c_odes' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_c_odes(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("c_odes", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_c_odes) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "c_odes")) {
      if (unlikely(PyDict_SetItemString(modules, "c_odes", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef cnp.ndarray[cnp.double_t, ndim=1] dY = np.empty(y.size, \
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6c_odes_1cy_odes, NULL, __pyx_n_s_c_odes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cy_odes, __pyx_t_1) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "c_odes_wrapper.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init c_odes", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init c_odes");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
